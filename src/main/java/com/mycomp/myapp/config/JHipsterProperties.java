...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "mymicroapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "mymicroapp API";

        private String description = "mymicroapp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "mymicroapp";
